...
//arrow key press for next and prev btn
    ...
    if (currentState > 1) {
        switch (currentState) {
            case 2:
                ...
                paper1.style.zIndex = 19;
                break;
            case 3:
                paper2.classList.remove("flipped");
                paper2.style.zIndex = 18;
                break;
            case 4:
                paper3.classList.remove("flipped");
                paper3.style.zIndex = 17;
                break;
            case 5:
                paper4.classList.remove("flipped");
                paper4.style.zIndex = 16;
                break;
            case 6:
